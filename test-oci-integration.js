import { OCIInventoryService } from './server/services/oci-inventory.js';
...
async function testOCI() {
  try {
    console.log('Testing OCI integration...');
    ...
    console.log('Resources discovered:', inventory.resources.length);
    console.log('Sample resource:', inventory.resources[0]);
